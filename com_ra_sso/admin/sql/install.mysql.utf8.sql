CREATE TABLE IF NOT EXISTS `#__ra_sso_customer` (
    ...
    `ra_sso_fifteen_days_before_lexp` TINYINT(1) DEFAULT 0,
    `ra_sso_five_days_before_lexp` TINYINT(1) DEFAULT 0,
    `ra_sso_after_lexp` TINYINT(1) DEFAULT 0,
    `ra_sso_after_five_days_lexp` TINYINT(1) DEFAULT 0,
    `ra_sso_lexp_notification_sent` TINYINT(1) DEFAULT 0,
    `ra_sso_no_notification_sent` TINYINT(1) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__ra_sso_config` (
    `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    `raSsoAttributeMap` VARCHAR(512) NOT NULL DEFAULT '{"profile":[],"field":[]}',
...
CREATE TABLE IF NOT EXISTS `#__ra_sso_logs` (
...
INSERT IGNORE INTO `#__ra_sso_customer` (`id`, `login_status`, `sso_var`) VALUES (1, FALSE, 'MjU=');
INSERT IGNORE INTO `#__ra_sso_config` (`id`, `usrlmt`) VALUES (1, 10);